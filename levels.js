...
CFG.enemies = [
  ...
  // ===== 第20关 Boss：骑兵统领 =====
  {id:20,name:'骑兵统领',desc:'BOSS·铁骑如潮，雷霆万钧',units:{cavalry:[1,1,1],spearman:[1,1],infantry:[1],archer:[1,1]},boss:true,bossMult:{atk:1.35,def:1.30},reward:{wood:2200,stone:1700,food:1500},drops:{bow_essence:{prob:0.6,count:1},crossbow_essence:{prob:0.6,count:1},blade_essence:{prob:0.6,count:1}}},
