...
CFG.buildings = {
  ...
  infantry_camp:{name:'步兵营地',trains:'infantry',unitCap:[0,6,8,10,12,14,16,18,20,22],build:{wood:180,stone:100,food:80,time:5},upBase:{wood:1600,stone:1000,food:800},upCostLv:1.7},
  archer_range:{name:'射手靶场',trains:'archer',unitCap:[0,4,6,8,10,12,14,16,18,20],build:{wood:240,stone:100,food:100,time:6},upBase:{wood:2000,stone:1000,food:1000},upCostLv:1.75},
